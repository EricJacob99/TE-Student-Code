...
public class Exercises {
	...
	public String twoChar(String str, int n) {
		if ((n > str.length()) || (n+2 > str.length()) || n < 0) {
			return str.substring(0,2);
		} else {
	...
	public String stringTimes(String str, int n) {
		String copiedString = "";
		for (int i = 0; i < n; i++) {
			copiedString = copiedString.concat(str);
		}
		return copiedString;
	}
	...
	public String frontTimes(String str, int n) {
		if (str.length() < 3) {
			...
			String copiedString = "";
			for (int i = 0; i < n; i++) {
				copiedString = copiedString.concat(str.substring(0,3));
			}
			return copiedString;
		}
	}
	...
	public boolean doubleX(String str) {
		boolean firstx = true;
		char[] doubleXTest = str.toCharArray();
		for (int i = 0; i < str.length()-1; i++) {
			if (doubleXTest[i] == ('x')); {
				if (doubleXTest[i] == doubleXTest[i+1] && firstx) {
					return true;
				}
				firstx = false;
			}
...
//		return false;
	...
	public String stringBits(String str) {
		String stringBitsFinal = "";
		for (int i = 0; i < (str.length()); i+=2) {
			stringBitsFinal = stringBitsFinal.concat(str.substring(i,i+1));
		}
		return stringBitsFinal;
	}
	...
	public String stringSplosion(String str) {
		String stringSplosionFinal = "";
		for (int i = 1; i <= (str.length()); i++) {
			stringSplosionFinal = stringSplosionFinal.concat(str.substring(0,i));
		}
		return stringSplosionFinal;
	}
	...
	public int last2(String str) {
		if (str.length() >= 2) {
			...
			int lastTwoInstances = 0;
			for (int i = 0; i < str.length()-2; i++) {
				String tstString = str.substring(i,i+2);
				if (tstString.equals(lastTwo)) {
					lastTwoInstances++;
				}
			}
			return lastTwoInstances;
		} else {
			return 0;
		}
	...
	public String stringX(String str) {
		String finalStringX = "";
		if (str.length() >= 1) {
			finalStringX = finalStringX.concat(str.substring(0,1));
		}
		for (int i = 1; i < str.length()-1; i++) {
			if (str.substring(i,i+1).equals("x")) {
				continue;
			}else {
				finalStringX = finalStringX.concat(str.substring(i,i+1));
			}
		}
		if (str.length() >= 2) {
			finalStringX = finalStringX.concat(str.substring(str.length()-1,str.length()));
		}
		return finalStringX;
	}
	...
	public String altPairs(String str) {
		String altPairsFinal = "";
		for (int i = 0; i < (str.length()); i+=4) {
			altPairsFinal = altPairsFinal.concat(str.substring(i,i+1));
			if (str.length() > i+1) {
				altPairsFinal = altPairsFinal.concat(str.substring(i+1,i+2));
			}
		}
		return altPairsFinal;
	}
