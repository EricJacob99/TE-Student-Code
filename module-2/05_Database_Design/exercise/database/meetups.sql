...
DROP TABLE IF EXISTS member, interest_group, event, group_members, event_members CASCADE;
...
INSERT INTO member (first_name, last_name, email_address, phone_number, date_of_birth, email_offers) VALUES ('Brad', 'Pitt', 'bradman@hotmale.com', '6153482206', '1963-12-18', TRUE);
INSERT INTO member (first_name, last_name, email_address, phone_number, date_of_birth, email_offers) VALUES ('Catherine', 'Romanova', 'thegreatest@empire.ru', '7324475904', '1729-05-02', TRUE);
...
INSERT INTO member (first_name, last_name, email_address, phone_number, date_of_birth, email_offers) VALUES ('Emma', 'Watson', 'peakedinhighschool@hogwarts.uk', '6289251782', '1990-04-15', TRUE);
...
INSERT INTO member (first_name, last_name, email_address, phone_number, date_of_birth, email_offers) VALUES ('Gemma', 'Chan', 'crazyrich@hollywood.net', '7388829251', '1982-11-29', TRUE);
INSERT INTO member (first_name, last_name, email_address, phone_number, date_of_birth, email_offers) VALUES ('Hank', 'Green', 'coolscienceguy@gmail.com', '6148830318', '1980-05-05', TRUE);

INSERT INTO interest_group (group_name, number_of_members) VALUES ('ScienceBros', 0);
INSERT INTO interest_group (group_name, number_of_members) VALUES ('RichAndCrazy', 0);
INSERT INTO interest_group (group_name, number_of_members) VALUES ('OldSchoolBlues', 0);

INSERT INTO event (event_name, description, start_date_and_time, duration, organizing_group, number_of_members) VALUES ('Steampunk Sharktank', 'Present your business proposals to a panel of angel investors.', '2024-03-25 10:30:00', 120, (SELECT group_name FROM interest_group WHERE group_id = 1), 0);
INSERT INTO event (event_name, description, start_date_and_time, duration, organizing_group, number_of_members) VALUES ('Meet Gala', 'No, we didnt misspell Met. We just couldnt afford the licencing cost.', '2024-08-05 13:00:00', 300, (SELECT group_name FROM interest_group WHERE group_id = 2), 0);
INSERT INTO event (event_name, description, start_date_and_time, duration, organizing_group, number_of_members) VALUES ('Silent Theatre', 'Rewatch some of Charlie Chaplins greatest movies.', '2024-10-20 16:00:00', 240, (SELECT group_name FROM interest_group WHERE group_id = 3), 0);
